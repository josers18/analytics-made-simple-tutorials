# Grok Tutorial 2: Grok Build Terminal Agent Workflows

> **Official Companion Guide for [Analytics Made Simple: Grok Build Tutorial](https://analyticsmadesimple.com/series/grok/)**
> Raw Script: [`02_grok_build_terminal_agent.sh`](./02_grok_build_terminal_agent.sh)

Grok Build is a terminal-based coding agent. To prevent unexpected mass refactors, always execute the **Explore → Change → Check** loop.

---

## The Complete Script

Below is the sandbox initialization script contained in [`02_grok_build_terminal_agent.sh`](./02_grok_build_terminal_agent.sh):
...
```bash
bash grok/02_grok_build_terminal_agent.sh
```

👉 Next: [Part 3: Real-Time Live Search & Source Verification](./03_grok_live_search_verification.md)
